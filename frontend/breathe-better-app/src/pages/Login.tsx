...
import { Wind, Mail, ArrowRight, Eye, EyeOff } from "lucide-react";
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background gradient-mesh flex flex-col items-center justify-center relative overflow-hidden px-6">
      <motion.div
      ...
      >
        ...
        <div className="glass-card p-8">
          <h1 className="text-2xl font-display font-bold mb-1 text-center">Welcome back</h1>
          <p className="text-muted-foreground text-sm mb-6 text-center">Login to continue your health journey</p>
          ...
          <div className="mt-4 pt-4 border-t border-white/5">
            <button
              ...
              className="w-full py-3 rounded-xl border border-primary/20 bg-primary/5 text-primary text-sm font-semibold hover:bg-primary/10 transition-colors press-effect"
            >
              Try Demo Mode (Local Testing)
            </button>
          </div>
        </div>
